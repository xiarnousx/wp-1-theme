...
class Search {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(universityData.root_url + "/wp-json/university/v1/search?term=" + this.searchField.val(), results => {
      this.resultsDiv.html(`
        ...
        <div class="one-third">
            ...
            ${results.generalInfo.length === 0 ? "<p>No general information matches result</p>" : ""}
        ...
        <div class="one-third">
            <h2 class="search-overlay__section-title">Programs</h2>
              ${results.programs.length === 0 ? `<p>No programs matche result <a href='${universityData.root_url}/programs'>Viewl all programs</a> </p>` : ""}
            <ul class="link-list min-list" >   
                        ${results.programs.map(item => `<li><a href="${item.permalink}">${item.title}</a></li>`).join("")}
                    </ul>
            <h2 class="search-overlay__section-title">Professors</h2>
              ${results.professors.length === 0 ? `<p>No professors match results </p>` : ""}
        ...
        <h2 class="search-overlay__section-title">Campuses</h2>
          ${results.campuses.length === 0 ? `<p>No campuses matche result <a href='${universityData.root_url}/campuses'>Viewl all campuses</a> </p>` : ""}
        <ul class="link-list min-list" >  
                        ${results.campuses.map(item => `<li><a href="${item.permalink}">${item.title}</a></li>`).join("")}
                    </ul>
        <h2 class="search-overlay__section-title">Events</h2>
            ${results.events.length === 0 ? `<p>No events match result <a href='${universityData.root_url}/events'>Viewl all events</a> </p>` : ""}
  ...
  keyPressDispatcher(e) {
    if (e.keyCode === 83 && !this.isOverlayOpen && !jquery__WEBPACK_IMPORTED_MODULE_0___default()("input, textarea").is(":focus")) return this.openOverlay();
    if (e.keyCode === 27 && this.isOverlayOpen && !jquery__WEBPACK_IMPORTED_MODULE_0___default()("input, textarea").is(":focus")) return this.closeOverlay();
  }
  addSearchHtml() {
    const overlay = `
        ...
        `;
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("body").append(overlay);
  }
}
